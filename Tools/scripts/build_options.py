...
BUILD_OPTIONS = [
    ...
    Feature('MAVLink', 'MAVLINK_MSG_FLIGHT_INFORMATION', 'AP_MAVLINK_MSG_FLIGHT_INFORMATION_ENABLED', 'Enable sending of MAVLink FLIGHT_INFORMATION message', 0, None),  # noqa
