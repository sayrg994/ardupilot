...
receive pin for UARTn. The Tn pin is the transmit pin for UARTn.
 ...
 - SERIAL7 -> UART7
 - SERIAL8 -> UART8 (DJI/MSP, DMA-enabled)
...
The Flywoo H743 Pro supports OSD using OSD_TYPE 1 (MAX7456 driver).

## PWM Output

The Flywoo H743 Pro supports up to 13 PWM outputs. The pads for motor output
