...
public:
    ...
    virtual bool set_tracking_internal(TrackingType tracking_type, const Vector2f& p1, const Vector2f& p2) { return false; }

    // Onboard controller specific tracking
    bool set_tracking_external(TrackingType tracking_type, const Vector2f& p1, const Vector2f& p2);
